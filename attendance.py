...
class Attendance:
    def __init__(self,root):
        ...
        bg_img.place(x=0,y=200,width=1535,height=710)
        ...
        date_entry.grid(row=2,column=3,padx=10,pady=5,sticky=W)
         ...
         # attendance
        atten_label=Label(left_inside_frame,text="Attendance Status: ",font=("times new roman",13,"bold"),bg="white")
        atten_label.grid(row=3,column=0,padx=10,pady=5,sticky=W)

        self.atten_combo=ttk.Combobox(left_inside_frame,font=("times new roman",13,"bold"),textvariable=self.var_atten_attendance,state="readonly",width=20)
        self.atten_combo["values"]=("Status","Present","Absent")
        self.atten_combo.current(0)
        self.atten_combo.grid(row=3,column=1,padx=2,pady=5,sticky=W)
