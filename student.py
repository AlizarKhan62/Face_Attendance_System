...
class Student:
    def __init__(self,root):
        ...
        self.var_teacher=StringVar()
         ...
         # 1st image
        img = Image.open(r"D:\Face Attendence System\college_images\face-recognition.png")
        ...
        # 2nd image
        img1 = Image.open(r"D:\Face Attendence System\college_images\smart-attendance.jpg")
        ...
        # 3rd image
        img2 = Image.open(r"D:\Face Attendence System\college_images\student3.jpg")
        ...
        img_left = Image.open(r"D:\Face Attendence System\college_images\AdobeStock_303989091.jpeg")
        ...
        semester_combo["values"]=("Select Semester","Sem1","Sem2")
        ...
        img_right = Image.open(r"D:\Face Attendence System\college_images\studentss.jpg")
        ...
        search_label=Label(search_frame,text="Select By:",font=("times new roman",15,"bold"),bg="red",fg="white")
    ...
    def delete_data(self):
        if self.var_std_id.get()=='':
            ...
            try:
                delete=messagebox.askyesno('Student Delete','Do you want to delete student details?',parent=self.root)
                if delete>0:                  
                   conn=mysql.connector.connect(host='localhost', username='root', password='qasimsial51214@', database='face_recog')
                   my_cursor=conn.cursor()
