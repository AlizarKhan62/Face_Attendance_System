...
class login_window:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r'D:\Face Attendence System\college_images\hackers2.jpg')
        ...
        img1=Image.open(r'D:\Face Attendence System\college_images\LoginIconAppl.png')
        ...
        # image icons 
        img2=Image.open(r'D:\Face Attendence System\college_images\LoginIconAppl.png')
        img2=img2.resize((25,25),Image.Resampling.LANCZOS)
        self.photoimg2=ImageTk.PhotoImage(img2)
        lblimg2=Label(image=self.photoimg2,bg='black',borderwidth=0)
        lblimg2.place(x=650,y=323,width=25,height=25)

        img3=Image.open(r'D:\Face Attendence System\college_images\lock-512.png')
        ...
        # forgot pass button
        forpassbtn=Button(frame,text='Forget Password',command=self.forgot_password_window,font=('times new roman',10,'bold'),borderwidth=0,fg='white',bg='black',activebackground='black',activeforeground='white')
    ...
    def login(self):
        if self.txtuser.get()=='' or self.txtpass.get()=='':
            ...
            messagebox.showinfo('Success','Welcome to my Channel')
        else:
            conn=mysql.connector.connect(host='localhost', username='root', password='qasimsial51214@', database='face_recog')
    ...
    def forgot_password_window(self):
        if self.txtuser.get()=='':
            ...
            if row==None:
                messagebox.showerror('My Error','Please enter valid credentials')
            else:
                conn.close()
                self.root2=Toplevel()
...
class Register:
    def __init__(self,root):
        ...
        # left img 
        self.bg1=ImageTk.PhotoImage(file=r'D:\Face Attendence System\college_images\thought-good-morning-messages-LoveSove.jpg')
        ...
        self.txt_con_pswd=ttk.Entry(frame,textvariable=self.var_confpass,font=('times new roman',15))
        self.txt_con_pswd.place(x=370,y=340,width=250)
        ...
        # BUTTONS 
        img=Image.open(r'D:\Face Attendence System\college_images\register-now-button1.jpg')
        img=img.resize((200,55),Image.Resampling.LANCZOS)
        self.photoimg=ImageTk.PhotoImage(img)
        b1=Button(frame,image=self.photoimg,borderwidth=0,cursor='hand2',command=self.register_data,font=('times new roman',15,'bold'),fg='white')
        b1.place(x=10,y=420,width=200)

        img1=Image.open(r'D:\Face Attendence System\college_images\loginpng.png')
